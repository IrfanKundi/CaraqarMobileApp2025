...
class _NewsDetailScreenState extends State<NewsDetailScreen> {
  ...
  void initState() {
    ...
    if(news.pdfs.isNotEmpty){
      createFileOfPdfUrl(news.pdfs.first).then((f) {
        setState(() {
          pdfPath = f.path;
        });
      });
    ...
    List<String> parts = divideDescription(news.description!, 500);
    part1 = parts[0];
    part2 = parts[1];
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: buildAppBar(context,title: "News".tr),
      body: SafeArea(
        child: ListView(
          children: [
            Padding(
            ...
            Container(
                ...
                // Text(news.description!,style: Get.textTheme.titleMedium,textAlign: TextAlign.justify)

            ) :
            const SizedBox(),

            news.videoUrls.isNotEmpty?Column(children: [
              (part1!=null || part1!="")?
              Container(
                  padding: kScreenPadding,
              ...
              SizedBox(
                  height: 0.3.sh,
                  width: 1.sw,
                  child: YoutubePlayerScreen(videoUrls: news.videoUrls)),
            ...
            news.pdfs.isNotEmpty?Column(
              children: news.pdfs.map((e) => InkWell(
                onTap: () async {

                  if(news.pdfs.first==e){
