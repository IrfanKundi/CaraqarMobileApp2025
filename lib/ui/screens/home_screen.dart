...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    homeController.tabController = TabController(initialIndex: 0, length: 3, vsync: this);
    ...
    homeController.tabController.addListener(() {
      ...
      if (homeController.tabController.index == 1) {
        ...
        body: NestedScrollView(
                        ...
                        Expanded(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              homeController.propertyController.getFilteredProperties();
                        ...
                        background: Stack(
                          ...
                          children: [
                            (homeController.contentController.homeContent != null &&
                              ...
                              width: 1.sw,),
                                  Positioned(
                              bottom: Platform.isIOS ? 0.15.sh : 0.13.sh,
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    gSelectedCountry?.countryId!=11? GestureDetector(
                                      onTap: () {
                                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => ComingSoonScreen(title: "Foreigner Screen",)),);
                                      },
                                      child: Container(
                                        height: 40.h,
                                        margin:
                                        ...
                                        children: [
                                          Expanded(
                                            child: GestureDetector(
                                              onTap: () {
                                                homeController.propertyController.resetFilters();
                                                homeController.propertyController.isBuyerMode.value = true;
                                                homeController.propertyController.getFilteredProperties();
                                                Get.toNamed(
                                          ...
                                          Expanded(
                                              child: GestureDetector(
                                                onTap: () {
                                                  homeController.propertyController.resetFilters();
                                                  homeController.propertyController.isBuyerMode.value = false;
                                                  homeController.propertyController.getFilteredProperties();
                                                  Get.toNamed(
                                                      Routes.propertiesScreen);
                                                },
                                    ...
                                    Container(
                                      ...
                                      child: Obx(() => homeController.typeController.typesStatus.value == Status.loading?
                                      ShimmerWidget(
                                          child: Row(
                                          ...
                                          : homeController.typeController.typesStatus.value == Status.error
                                          ? Text(kCouldNotLoadData.tr, style: kTextStyle16)
                                          : Row(
                                        children: homeController.typeController.searchedTypes.map((element) {
                                          var item = element;
                                          ...
                                          return Expanded(
                                            child: Container(
                                              ...
                                              child: InkWell(
                                                onTap: () {
                                                  homeController.typeController.getSubTypes(item);
                                                  Get.toNamed(Routes.chooseSubtypeScreen, arguments: item);
                                                },
                                                child: Column(
          ...
          body: TabBarView(controller: homeController.tabController, children: [
            GetBuilder<PropertyController>(
                builder: (controller) => controller.nearByStatus.value == Status.loading
                    ? ShimmerWidget(
                  ...
                  child: Padding(
                    ...
                    padding: kScreenPadding.copyWith(bottom: 50.h),
                    itemBuilder: (context, index) {
                      var item = controller.nearByProperties.value[index];
                      return SizedBox(
                          height: 0.35.sh,
                          width: 1.sw,
            ...
            GetBuilder<PropertyController>(
                builder: (controller) => controller.recomStatus.value == Status.loading
                    ? ShimmerWidget(
                  child: ListView.separated(
                      padding: kScreenPadding.copyWith(bottom: 50.h),
                      itemBuilder: (context, index) {
                  ...
                  child: Text(kCouldNotLoadData.tr,
                    ...
                    itemBuilder: (context, index) {
                      var item = controller
                          .recommendedProperties.value[index];
                      return SizedBox(
                          height: 0.35.sh,
                          width: 1.sw,
                          child: PropertyItem(item: item));
                  ...
                  child: Padding(
                    padding: kHorizontalScreenPadding,
                    child: Text("0 ${"PropertiesFound".tr}",
                        style: kTextStyle16),
                  ),
                )),
            GetBuilder<PropertyController>(
                builder: (controller) => controller.followedStatus.value == Status.loading
                    ? ShimmerWidget(
                  child: ListView.separated(
                      padding: kScreenPadding.copyWith(bottom: 50.h),
                      itemBuilder: (context, index) {
                  ...
                  child: Text(kCouldNotLoadData.tr,
                    ...
                    itemBuilder: (context, index) {
                      var item = controller
                          .followedProperties.value[index];
                      return SizedBox(
                          height: 0.35.sh,
                          width: 1.sw,
                          child: PropertyItem(item: item));
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        ...
        Get.toNamed(Routes.viewPropertyScreen, arguments: widget.item)?.then((value) {
          if(mounted){
            setState(() {
                        ...
                        IconButtonWidget(
                            ...
                            onPressed: ()async {
                              if(widget.item.favoriteId!>0){
                                if(await Get.put(FavoriteController()).deleteFavorite(property: widget.item)){
                                  if(mounted){
                                    setState(() {});
                                  }
                                }
                              }else{
                                if(await Get.put(FavoriteController()).addToFavorites(property:widget.item)){
                                  if(mounted){
                                    setState(() {});
                                  }
                                }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      maxLines: 1,
                      style: TextStyle(
                          color: kGreyColor, height: 1.3.h, fontSize: 12.sp),
                    ),
                    FittedBox(
                      fit: BoxFit.scaleDown,
