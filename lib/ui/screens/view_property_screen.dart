          ...
          headerSliverBuilder: (BuildContext context,
            ...
            return <Widget>[
              SliverAppBar(
                  ...
                  title: Row(
                    children: [
                      Expanded(child: Text("Details".tr.toUpperCase(),
                      ...
                      IconButtonWidget(icon: MaterialCommunityIcons
                        ...
                        onPressed: () async {
                          ...
                          String webUrl = "$kFileBaseUrl/Properties/Detail/${property
                              .propertyId}";
                        ...
                        GestureDetector(
                          onTap: () {
                            if (property?.companyId != null) {
                              if (Get.previousRoute == "${Routes
                                  .companyScreen}?type=Real State&agentAds=${property
                                  ?.isAgentAd}") {
                                Get.back();
                              } else {
                              ...
                              if (Get.previousRoute == "${Routes
                                  .agentScreen}?type=Real State&agentAds=${property
                                  ?.isAgentAd}") {
                                Get.back();
                              }
                              else {
                          ...
                          child: ImageWidget(property?.agentImage == "" ||
                              property?.agentImage == null
                              ? "assets/images/profile2.jpg"
                              : property?.agentImage, width: 70.r,
                            height: 70.r,
                            isCircular: true,
                            isLocalImage: property?.agentImage == "" ||
                                property?.agentImage == null,
                            fit: BoxFit.cover,),
                        ),
                            ...
                            children: [
                              Text("${property?.agentName}",
                                style: kTextStyle16.copyWith(
                                    color: kAccentColor),),
                              kVerticalSpace4,
                              Text("Owner".tr, style: kTextStyle14.copyWith(
                                  color: kGreyColor),),
                          ...
                          child: OutlinedButton(
                            onPressed: () async {
                              ...
                              String adUrl = await DynamicLink
                                  ...
                                  uri: "/Properties/Detail/${property
                                      ?.propertyId}",
                                  title: property?.title,
                                  desc: property?.description,
                                  image: property?.images.first);
                              ...
                              if (Platform.isIOS) {
                                url =
                                "https://wa.me/${property
                                    ?.contactNo}?text=$message";
                              } else {
                                url =
                                "whatsapp://send?phone=${property
                                    ?.contactNo}&text=$message";
                              }
                              try {
                            ...
                            child: Image.asset(
                              "assets/images/whatsapp.png", width: 22.w,),
                          ),
                        ),
                        (property?.email != null &&
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              pLatitude != null && pLongitude != null
                                ...
                                child: Card(
                                  ...
                                  elevation: 2,
                                  // Set elevation to 0 to remove the box shadow
                                  child: Container(
                                    width: Get.width,
                                ...
                                onTap: () async {
                                  var uri = Uri.parse(
                                      "https://www.google.com/maps/search/?api=1&query=${property
                                          .coordinates}");
                                  if (await canLaunchUrl(uri)) {
                                    try {
                                      ...
                                      if (kDebugMode) {
                                        print(
                                            'Failed to launch Google Maps: $e');
                                      }
                                    }
                                  } else {
                                    if (kDebugMode) {
                          ...
                          if( property.featureHeads.isNotEmpty)
                            Padding(
                              ...
                              child: Text("Features/Amenities".tr,
                                style: kTextStyle16.copyWith(
                                    color: kAccentColor),),
                            ),
