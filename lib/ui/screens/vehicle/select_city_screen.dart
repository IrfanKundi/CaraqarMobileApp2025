...
class SelectCityScreen extends GetView<VehicleController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CityController>(builder: (cityController)=> cityController
          .status.value ==
          Status.loading
          ? CircularLoader():

      cityController.status.value ==
          Status.error
      ...
      Column(
        children: [
          Padding(
            ...
            child: CupertinoSearchTextField(onChanged: (val) => cityController.search(val), placeholder: "Search".tr),
          ),
          Expanded(
    ...
    Get.toNamed(Routes.reviewAdScreen);
                    ...
                    child:Container(
                      decoration: BoxDecoration(
                        color: controller.cityId==item.cityId?kLightBlueColor:null,
                        border: Border.all(color: controller.cityId==item.cityId?kLightBlueColor:kGreyColor),
