                    ...
                    IconButtonWidget(
                      ...
                      onPressed: () async {
                        String adUrl = await DynamicLink.createDynamicLink(
                          ...
                          title:
                          "${car?.brandName} ${car?.modelName} ${car
                              ?.modelYear}",
                          ...
                          onTap: () {
                            if (car?.companyId != null) {
                              if (Get.previousRoute ==
                                  "${Routes
                                      .companyScreen}?type=Car&agentAds=${car
                                      ?.isAgentAd}") {
                                Get.back();
                              } else {
                                Get.offNamed(
                              ...
                              if (Get.previousRoute ==
                                  "${Routes.agentScreen}?type=Car&agentAds=${car
                                      ?.isAgentAd}") {
                                Get.back();
                              } else {
                                Get.offNamed(
                        ...
                        (car.email != null &&
                          ...
                          child: OutlinedButton(
                            onPressed: () async {
                              ...
                              String webUrl =
                                  "https://www.caraqar.co/Cars/Detail/${car
                                  .carId}";
                            ...
                            Expanded(
                              child: Column(
                                children: [
                                  ...
                                  kVerticalSpace8,
                                  Text(
                                    car.importedLocal?.isNotEmpty == true ? car
                                        .importedLocal! : "Not Available",
                                    style: kTextStyle16.copyWith(
                                        color: kAccentColor),
                                  ),
                                ],
