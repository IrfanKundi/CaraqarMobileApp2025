...
class ReviewAdScreen extends GetView<VehicleController> {
                  ...
                  return Column(
                    ...
                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text("English".tr,
                                              ...
                                              style: gSelectedCountry?.countryId == 11 ? kLightTextStyle12 : controller.lang == 0 ? kLightTextStyle12 : kTextStyle12),
                                        ),
                                      ),
                                      gSelectedCountry?.countryId == 11 ? SizedBox() : InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text("Arabic".tr,
                                              textAlign: TextAlign.center,
                                              style: controller.lang == 1 ? kLightTextStyle12 : kTextStyle12),
                                        ),
                                      ),
                                      gSelectedCountry?.countryId == 11 ? SizedBox() : InkWell(
                                        onTap: () {
                                        ...
                                        child: Container(
                                          ...
                                          child: Text("Both".tr,
                                              textAlign: TextAlign.center,
                                              style: controller.lang == 2 ? kLightTextStyle12 : kTextStyle12),
                                        ),
                                      ),
                                    ],
                                  ),
                                  ...
                                  children: [
                                    gSelectedCountry?.countryId == 11 || controller.lang == 0 || controller.lang == 2
                                      ...
                                      child: TextFieldWidget(
                                        ...
                                        : Container(),
                                    gSelectedCountry?.countryId != 11 && (controller.lang == 1 || controller.lang == 2)
                                        ? Padding(
                                      padding: EdgeInsets.only(bottom: 12.w),
                                      child: TextFieldWidget(
                              ...
                              GetBuilder<VehicleController>(
                                  builder: (controller) => GestureDetector(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                          color: kWhiteColor,
                                          border: Border.all(width: 1.w, color: kGreyColor.shade300),
                                          borderRadius: kBorderRadius4),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Wrap(
                                              runSpacing: 4.w,
                                              spacing: 4.w,
                                              children: controller.vehicleFeatures
                                                  .map((e) => Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    kHorizontalSpace4,
                                                    GestureDetector(
                                                      child: Icon(MaterialCommunityIcons.close, size: 15.w),
                                                      onTap: () {
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Text("Images".tr, style: kTextStyle16.copyWith(fontWeight: FontWeight.bold)),
                                kHorizontalSpace12,
                                TextButtonWidget(onPressed: controller.uploadImages, text: "AddImages"),
                              ],
                            ),
                            GetBuilder<VehicleController>(
                      ...
                      Container(
                        ...
                        child: ButtonWidget(
                          onPressed: controller.uploadNow,
                          text: "UploadNow",
                        ),
                      )
                    ],
  ...
  void _showExitConfirmation() {
    showConfirmationDialog(
      ...
      message: "Are you sure you want to leave? Your progress will be lost and cannot be recovered.",
      textConfirm: "Yes, Leave",
      textCancel: "No, Stay",
      onConfirm: () {
        Get.back(); // Close the dialog first
        Get.offAllNamed('/navigationScreen'); // Navigate to main page and clear all routes
